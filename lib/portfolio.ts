...
export const PORTFOLIO_ITEMS: PortfolioItem[] = [
  {
    ...
    mediaType: 'video',
    videoUrl: '/assets/portfolio/videos/reel2.mp4',
    ...
    gallery: [
      { type: 'video', src: '/assets/portfolio/videos/reel2.mp4', poster: '/assets/portfolio/wedding.png' },
  ...
  },
  {
    ...
    tagline: 'Luxury redefined in sixty seconds.',
    description:
      'A high-end commercial for a luxury fragrance brand. Deep blacks, shimmering golds, and slow-motion textures create an unforgettable sensory experience. Every frame is meticulously color-graded to evoke opulence and desire.',
    year: '2024',
    month: 'SEP',
    location: 'Mumbai, India',
    image: '/assets/portfolio/commercial.png',
    mediaType: 'video',
    videoUrl: '/assets/portfolio/14652279_3840_2160_50fps.mp4',
    ...
    group: 'trending',
    crew: [
      { role: 'Director', name: 'Vikram Mehta' },
      { role: 'DOP', name: 'Rohan Desai' },
    ],
    gallery: [
      { type: 'video', src: '/assets/portfolio/14652279_3840_2160_50fps.mp4', poster: '/assets/portfolio/commercial.png' },
      { type: 'image', src: '/assets/portfolio/commercial.png', alt: 'Product hero shot' },
    ],
  },
  {
    id: 'ember-and-oak',
    ...
    gallery: [
      { type: 'video', src: '/assets/portfolio/videos/reel2.mp4', poster: '/assets/portfolio/brand.png' },
  ...
  },
  {
    ...
    tagline: 'Motion as emotion. Speed as poetry.',
    description:
      'A high-octane compilation reel showcasing speed, motion, and dynamic camera work. Drone aerials and stabilized tracking shots at their finest, capturing the raw energy of movement.',
    year: '2024',
    month: 'JAN',
    location: 'Goa, India',
    ...
    mediaType: 'video',
    videoUrl: '/assets/portfolio/14652279_3840_2160_50fps.mp4',
    tags: ['Reel', 'Action', 'Aerial'],
    client: 'Studio Showreel',
    duration: '2 min',
    group: 'trending',
    crew: [
      { role: 'Lead Editor', name: 'Karan Singh' },
      { role: 'Drone Operator', name: 'Aakash Patel' },
    ],
    gallery: [
      { type: 'video', src: '/assets/portfolio/14652279_3840_2160_50fps.mp4', poster: '/assets/portfolio/reel.png' },
      { type: 'image', src: '/assets/portfolio/reel.png', alt: 'Aerial tracking shot' },
    ],
  },
  {
    id: 'cinematic-flow',
    ...
    gallery: [
      { type: 'video', src: '/assets/portfolio/videos/reel2.mp4', poster: '/assets/portfolio/reel.png' },
    ],
  },
  {
    id: 'bloom',
  ...
  },
  {
    ...
    gallery: [
      { type: 'video', src: '/assets/portfolio/videos/reel2.mp4', poster: '/assets/portfolio/motion.png' },
