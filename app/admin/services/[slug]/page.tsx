  ...
  if (fetching) {
    return (
      <div className="flex min-h-[50vh] items-center justify-center">
        <Loader2 className="h-8 w-8 animate-spin text-cinematic-orange" />
      </div>
    );
  }
    ...
    <div className="mx-auto max-w-4xl pb-20 text-stone-900">
      ...
      <div className="mb-10 bg-white border border-stone-200 p-8 rounded-3xl shadow-xs">
        <h1 className="font-heading text-4xl font-light text-stone-900">
          Edit <span className="text-gradient-warm italic font-medium">Service</span>
        </h1>
        <p className="mt-2 text-stone-500 font-light">Update your agency&rsquo;s service details.</p>
      </div>
